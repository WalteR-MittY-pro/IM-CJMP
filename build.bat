...
if "%buildTarget%"=="android" (
    ...
    set ANDROID_PACKAGE=!SCRIPT_DIR!\package\target\!cangjieTarget!\!buildType!\telegram_cjmp
...
) else if "%buildTarget%"=="ohos" (
    set cangjieTarget=aarch64-linux-ohos
)
...
if "%buildTarget%"=="android" (
    ...
    call :analyze_dependencies "!outputDir!\arm64-v8a" "android" "!ANDROID_CANGJIE_PATH!" "!ANDROID_CJ_FRONTEND!" "!ANDROID_CANGJIE_STDX_PATH!"
